...
int Main_window::icons_type(std::string name){
  if(name.find(".txt")!=std::string::npos) return 1; 
  else if(name.find(".pdf")!=std::string::npos) return 2;  
  else if(name=="."|| name=="..") return 3;    
  else if(name.find(".cpp")!=std::string::npos) return 4;
  else if(name.find(".h")!=std::string::npos) return 5; 
  else return 6;
}
